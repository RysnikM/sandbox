...
arrPropertiesHeader.forEach(function(nameElement, numberGrafic){
			...
			$('body').append('<div class="container-fluid border border-dark"><div class="row" id="FP'+numberGrafic+'"><div class="col-12 col-sm-12 col-xl-3 flex-column border border-top-0 border-primary"><div class="row d-flex d-md-flex justify-content-center align-items-center m-auto m-md-auto" style="font-family:Ubuntu, sans-serif;margin-top:0px;margin-bottom:0px;padding-top:10px;"><div class="col-12 col-sm-12 col-md-12 d-flex d-sm-flex d-md-flex flex-column flex-grow-1 flex-shrink-1 flex-fill justify-content-center align-items-center align-content-center align-self-center m-auto justify-content-sm-center align-content-sm-center align-self-sm-center m-sm-auto flex-md-column flex-md-grow-1 flex-md-shrink-1 flex-md-fill justify-content-md-center align-content-md-center align-self-md-center m-md-auto" style="padding-top:0px;padding-bottom:5px;">                    <h1 class="text-monospace text-nowrap text-center d-flex justify-content-center" style="font-family:Ubuntu, sans-serif;margin:0px;color:rgb(41,33,34);"><span style="text-decoration: underline;" id="'+arrPropertiesHeader[numberGrafic]+'">Текущая величина</span></h1></div></div><div class="row align-items-center" style="margin-top:5px;margin-bottom:5px;margin-right:-22px;"><div class="col-6 text-md-center text-sm-center"><span class="justify-content-start">Уставка аварии:</span></div><div class="col-6 col-md-6 col-xl-6 d-flex justify-content-center align-self-center justify-content-md-center text-center justify-content-sm-center"><input type="number" placeholder="Введите уставку" class="float-right align-self-start flex-nowrap text-center" name="ALARM'+numberGrafic+'" id="ALARM'+numberGrafic+'" style="z-index:5;" /></div>           </div><div class="row align-items-center" style="margin-right:-22px;margin-left:-15px;margin-top:0px;margin-bottom:5px;"><div class="col-6 align-self-center text-md-center text-sm-center"><span class="justify-content-start">Уставка остановки:</span></div><div class="col-6 col-md-6 col-xl-6 d-flex flex-fill justify-content-center justify-content-sm-center m-md-auto text-center justify-content-md-center justify-content-sm-center"><input type="number" placeholder="Введите уставку" name="ALARM'+numberGrafic+'" class="float-right align-self-start flex-nowrap text-center" id="STOP'+numberGrafic+'" style="z-index:5;" /></div></div><div class="row align-items-center" style="margin-top:5px;margin-right:-22px;margin-bottom:5px;padding-top:0px;"><div class="col-6 align-self-center text-md-center text-sm-center"><span class="justify-content-start text-center">Уставка предупреждения:</span></div><div class="col-6 d-flex justify-content-center justify-content-sm-center justify-content-md-center"><input type="number" placeholder="Введите уставку" class="float-right flex-nowrap text-center" name="WARNING'+numberGrafic+'" id="WARNING'+numberGrafic+'" style="z-index:5;" /></div>    </div><div class="row no-gutters justify-content-center align-items-center"><div class="col-12 justify-content-center align-items-center align-content-center" style="margin-bottom:10px;margin-top:10px;margin-right:0px;margin-left:0px;padding-right:0px;padding-left:0px;font-family:Ubuntu, sans-serif;"><button class="btn btn-success btn-block" type="button" style="padding:7px;padding-right:30px;padding-left:30px;padding-top:10px;padding-bottom:10px;" id="changeYaxesNameValue'+numberGrafic+'">Применить</button></div></div><div class="row"><div class="col-12 d-flex flex-grow-0 flex-shrink-0 flex-fill justify-content-center align-items-center align-content-center"><span class="text-monospace" style="font-family:Ubuntu, sans-serif;font-size:21px;">Вывод вспомогательных линий</span></div></div><div class="row no-gutters" style="margin-top:5px;margin-bottom:5px;"><div class="col-6 d-flex align-items-center flex-nowrap" style="cursor:pointer;"><i class="material-icons mr-2 chST" id="STOPcheck'+numberGrafic+'" style="z-index:5;">check_box</i><span>Линия остановки</span></div><div class="col-6 d-flex align-items-center flex-nowrap" style="cursor:pointer;"><i class="material-icons mr-2 chAL" id="ALARMcheck'+numberGrafic+'" style="z-index:5;">check_box</i><span>Линия аварии</span></div></div><div class="row no-gutters" style="margin-top:5px;margin-bottom:5px;"><div class="col-8 d-flex align-items-center flex-nowrap" style="cursor:pointer;"><i class="material-icons mr-2 chWR" id="WARNINGcheck'+numberGrafic+'" style="z-index:5;">check_box</i><span>Линия предупреждения</span></div></div><div class="row" style="margin-top:5px;margin-bottom:5px;"><div class="col-12 col-xl-12 align-self-center m-auto" style="margin-top:5px;margin-bottom:5px;"><span class="text-monospace d-flex flex-fill justify-content-center m-auto" style="font-family:Ubuntu, sans-serif;font-size:21px;">Вывод данных во времени</span></div></div><div class="row"><div class="col-6 col-xl-6 text-md-center"><span class="justify-content-start">Начало графика:</span></div><div class="col-6 col-xl-6 d-flex flex-fill justify-content-center align-self-center flex-wrap m-auto"><input type="datetime-local" step="1" class="float-right chDate" name="DATEfrom'+numberGrafic+'" id="DATEfrom'+numberGrafic+'" style="font-family:Ubuntu, sans-serif;width:179px;font-size:12px;z-index:5;" /></div></div><div class="row" style="margin-top:5px;margin-bottom:5px;"><div class="col-6 col-xl-6 text-md-center"><span class="justify-content-start">Окончание графика:</span></div><div class="col-6 col-xl-6 d-flex flex-fill justify-content-center align-self-center flex-wrap m-auto"><input type="datetime-local" step="1" class="float-right" name="DATEto'+numberGrafic+'"  id="DATEto'+numberGrafic+'" style="font-family:Ubuntu, sans-serif;width:179px;font-size:12px;z-index:5;" /></div></div><div class="row" style="margin-top:10px;margin-bottom:5px;"><div class="col-6 col-xl-6 d-flex flex-fill justify-content-center m-auto"><button class="btn btn-secondary pushCalendar" type="button" id="calendar'+numberGrafic+'" style="padding-top:10px;padding-bottom:10px;padding-right:20px;padding-left:20px;">Вывести период</button></div><div class="col-6 col-xl-6 d-flex flex-fill justify-content-center"><button class="btn btn-warning pushPause" type="button" id="onlinePause'+numberGrafic+'" style="padding-top:10px;padding-bottom:10px;padding-left:20px;padding-right:20px;">Пауза ONLINE</button></div></div></div></div></div>');
...
$("body").delegate('.chST','click',function(e){
	...
	var NumbButton=$(this).attr('id').match(/\d+/)[0];//номер графика для изменения
	 if (document.getElementById('STOPcheck'+NumbButton).checked) {
...
$("body").delegate('.chAL','click',function(e){
	...
	var NumbButton=$(this).attr('id').match(/\d+/)[0];//номер графика для изменения
	 if (document.getElementById('ALARMcheck'+NumbButton).checked) {
