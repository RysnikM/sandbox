  ...
  xAxis: {
    ...
    yAxis: {
        ...
        labels: {
            ...
            useHTML: true,
            formatter: function(){return '<span style="z-index:-5;font:16px Arial, sans-serif;white-space: nowrap;text-transform: uppercase;">'+this.value+' '+this.pos+' '+strCategories[this.pos]+'</span>' },
            style: {
            	// maxWidth: '20px',
              	// whiteSpace: 'nowrap',
